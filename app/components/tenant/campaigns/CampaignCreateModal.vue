<script setup lang="ts">
	...
	const hasPhone = (patient: PatientRecord) => String(patient.phone || "").trim().length > 0;
	...
	const selectedPatients = computed(() =>
		availablePatients.value.filter((patient) => form.patientIds.includes(String(patient.id))),
	);
					...
					<div class="campaign-patient-picker">
						...
						<div
							...
							<button
								...
								:key="patient.id"
								type="button"
								@click="form.patientIds = toggle(form.patientIds, String(patient.id))">
						...
						<div
							...
							class="campaign-patient-dropdown">
							<input
